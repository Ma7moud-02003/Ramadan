...
export const  sheikhs = [

  {
    ...
    description: "ترتيل بطيء وواضح للحفظ",
    qulity:128
  ...
  },
  {
    ...
    description: "ترتيل خاشع مع تدبر",
    qulity:128
    
  },
   {
    name: "الشيخ محمد صديق المنشاوي مجود",
    audioEdition: "ar.minshawimujawwad",
    description: "ترتيل خاشع مع تدبر",
    qulity:64
    
  },
    {
    name: "الشيخ محمد ايوب مجود",
    audioEdition: "ar.muhammadayyoub",
    description: "ترتيل خاشع مع تدبر",
    qulity:128
  },
  {
    name: "الشيخ عبدالباسط عبدالصمد",
    audioEdition: "ar.abdulbasitmurattal",
    description: "ترتيل واضح ومقامات جميلة",
    qulity:192
 ...
 
  {
    ...
    audioEdition: "ar.saoodshuraym",
    description: "ترتيل ثابت وواضح",
    qulity:64
  }
];
export const RevPer=[
  {name:'5 ايام', revPer:5},
  {name:'10 ايام', revPer:10},
  {name:'20 ايام', revPer:20},
  {name:'30 ايام', revPer:30},
]